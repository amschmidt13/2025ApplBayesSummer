This session extends the usual geostatistical model to the multivariate case introducing the Linear Model of Coregionalization. This session is based on the papers:
